...
if(isset($getproduct) && !empty($getproduct)) { 
   ...
   $IsCorporate = $getproduct->IsCorporate!=0 ? $getproduct->IsCorporate : '';
   $CorporateType = $getproduct->CorporateType!="" ? $getproduct->CorporateType : '';
...
<div class="content-wrapper">
	...
	<section class="content-header">
	  <h4>
		<?php echo $actionMsg; ?> Corporate product 
		<!--<small>Preview</small>-->
	  </h4>
	</section>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<select class="form-control validate[required]" name="CorporateType" id="category_id" >
									<?php if($CorporateType=='Best Seller Corporate Gifts'){ $sel = 'selected="selected"';}elseif($CorporateType=='Corporate Gifting Ideas'){$sel = 'selected="selected"';}else{$sel = '';} ?>
									<option value="" <?=$sel?>>--Select Category--</option>
									
									<option value="Best Seller Corporate Gifts" <?=$sel?>>Best Seller Corporate Gifts</option>
									<option value="Corporate Gifting Ideas" <?=$sel?>>Corporate Gifting Ideas</option>
								</select>
							</div>
