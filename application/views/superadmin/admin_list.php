...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Admin List
            <small>preview of Admin List</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="user_management.php">Change Password</a></li>
                                ...
                                if (count($user_data) > 0) {
                                    foreach ($user_data as $result) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a title="Edit" href="<?php echo base_url(); ?>changepwd/edit/<?php echo $result['user_pk_id']; ?>"><img src="<?php echo base_url() ?>assets/images/pencil.png" border="0px"></a>|&nbsp;&nbsp;
