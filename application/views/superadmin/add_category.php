                    ...
                    <form role="form" method="post">
                        <div class="box-body">
							...
							<label class="checkbox-inline">
							  ...
							  <input type="checkbox" <?php if($category_type == 1){ echo 'checked';}else{ echo "";}?> name="category_type" id="category_type" >As per Size, Price will Change
							</label>
                        </div>
                        <!-- /.box-body -->
...
function status_change(id,status){
	...
	swal({
	  title: "Are you sure to do category "+stc+"?",
	  //text: "You will not be able to recover this record!",
	  type: "warning",
	  showCancelButton: true,
	  confirmButtonColor: "#DD6B55",
