...
<div class="content-wrapper">
    ...
    <section class="content">
                        ...
                        <div class="col-md-12">
                            <table id="example1" class="table table-responsive">
                                ...
                                <tr>
									...
									<td><?=$cnt;?></td>
                                    <?php  $sql = "select * from fourth_advrt_baner where sec_advrt_id=".$result['advet_id'];
                                    ...
                                    <td>
									<a href="<?php echo base_url(); ?>frontend/edit_fourth_adv/<?php echo $result['advet_id']; ?>" class="btn btn-social-icon btn-primary"><i class="fa fa-pencil-square-o"></i></a> </td>
                                </tr>
								<?php $cnt++; } } else { ?>
								<?php } ?>
       ...
       <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="item-adv-simple">
                    <img src="<?php echo base_url(); ?>assets/images/image1.jpg" alt="" class="img-responsive" style="width: 500px;height: 160px;margin-bottom: 5px">
                </div>
                <div class="item-adv-simple">
                    <img src="<?php echo base_url(); ?>assets/images/image1.jpg" alt=""  class="img-responsive" style="width: 500px;height: 160px;margin-bottom: 5px">
                </div>
