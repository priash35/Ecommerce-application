<?php 
	$Id = $this->uri->segment('3');
	 ...
	 $sql = "SELECT fourth_advrt.*, sub_categories.* FROM sub_categories INNER JOIN fourth_advrt ON sub_categories.sc_pk_id=fourth_advrt.sub_cat where fourth_advrt.advet_id=".$Id;
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Third Section List</h3>
                    </div>
