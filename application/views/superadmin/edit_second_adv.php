<?php 
	...
	$sql = "SELECT adverties.*, sub_categories.* FROM sub_categories INNER JOIN adverties ON sub_categories.sc_pk_id=adverties.sub_cat where adverties.advet_id=".$Id;
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Second Section Image</h3>
                    </div>
