<?php 
	...
	$sql = "SELECT third_advrt.*, sub_categories.* FROM sub_categories INNER JOIN third_advrt ON sub_categories.sc_pk_id=third_advrt.sub_cat where third_advrt.advet_id=".$Id;
