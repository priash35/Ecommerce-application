...
if (isset($getproduct) && !empty($getproduct)) {
    ...
    $sz_category_name = $getproduct->size_category_fk_id != "" ? $getproduct->size_category_fk_id : '';
                                ...
                                <div class="form-horizontal">
                                    <div class="box-body">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="col-sm-7">
                                               	<input type="text" id="SUK" name="SUK" value="<?= $getproduct->SUK ?>" class="form-control validate[required,maxSize[50]]" placeholder="Item Code">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="col-sm-7">
                                                <span id="size_category">
                                                    ...
                                                    <select required class="form-control" name="size_cat" id="size_cat" >
...
<div class="btn-group" data-toggle="buttons">
                                        ...
                                        if (!empty($color_data)) {
                                            foreach ($color_data as $res) {
                                                ?>
                                                                                                                                                <label class="" style="background:<?php echo $res['color_code']; ?>">
                                                                                                                                                        <input type="checkbox" id="prod_color_<?php echo $res['color_pk_id']; ?>" name="prod_color" value="<?php echo $res['color_pk_id']; ?>" checked>
                                                                                                                                                </label>
                                                <?php
                                            }
                                        }
                                                    ...
                                                    <tbody id="product_size">
                                                        ...
                                                        foreach ($pro_size as $row) {
                                                            $ret .= "<tr>"
                                                                    ...
                                                                    . "<td><input type='text' value='" . $row['size_prize'] . "' class='form-control text-center unitprice' onkeyup='product_disc(" . $i . ")' name='unitprice[]' onkeypress='return isNumber(event)' placeholder='Unit Price' id='unitprice" . $i . "' data-rowid='" . $i . "'></td>"
                                                                    . "<td><input type='text' value='" . $row['size_descount'] . "' class='form-control text-center discount' onkeyup='product_disc(" . $i . ")' name='discount[]' onkeypress='return isNumber(event)' placeholder='Discount (%)' id='discount" . $i . "' data-rowid='" . $i . "'></td>"
                                                                    . "<td><input type='text' value='" . $row['size_qty'] . "' class='form-control text-center proquantity' name='quantity[]' placeholder='Quantity' id='quantity" . $i . "' data-rowid='" . $i . "'></td>"
                                                                    . "<td><input type='text' value='" . $row['size_descprice'] . "' class='form-control text-center discPrice' readonly name='discPrice[]' placeholder='Discount Price' id='discPrice" . $i . "' data-rowid='" . $i . "'></td>"
                                                                    . "<tr>";
                                                            $i++;
                                                        }
                                                        echo $ret;
                                            ...
                                            <div class="box-body col-md-10 input_fields_wrap">
                                                ...
                                                <table  class="table table-bordered ">
                                                    ...
                                                    <tbody id="appendArea" class="asdf">
                                                        ...
                                                        <?php
                                                        $i = 0;
//                                                        echo count($area_details);
                                                        foreach ($area_details as $row) {
                                                            ?>

                                                            <tr id="ss" rel="0" class="abc">
                                                                <td>
                                                                    <select id="" class="city_id form-control validate[required]" name="cityid_<?= $i ?>"> 
                                                                        <option value="">-- Please Select City --</option>
                                                                        <?php
                                                                        if (count($CityData) > 0) {
                                                                            foreach ($CityData as $result) {
                                                                                if ($result['city_pk_id'] == $row['city_id']) {
                                                                                    $selected = 'selected';
                                                                                } else {
                                                                                    $selected = '';
                                                                                }
                                                                ...
                                                                <td>
                                                                    <span id="AreaID">
                                                                        <?php
                                                                        $arealist = $this->product_model->get_arealist($row['city_id']);
                                                                        ?>
                                                                        <select class="form-control validate[required]" name="area_<?= $i ?>">
                                                                            <option value="">-- Please Select Area Pin code--</option>
                                                                            <?php foreach ($arealist as $rows) { ?>
                                                                                <option value="<?= $rows['area_pk_id'] ?>" <?= $rows['area_pk_id'] == $row['pa_areaID'] ? "selected" : "" ?> ><?= $rows['area_pin'] ?></option>
                                                                            <?php } ?>
                                                                ...
                                                                <td id="" class="areaClass"> <input  type="number" name="delivery_charges_<?= $i ?>" value="<?= $row['delivery_charges'] ?>" class="form-control"  placeholder="Delivery Charge"></td>
                                                                <td id="" class="areaClass"> <input type="number" name="no_of_days_<?= $i ?>" class="form-control" value="<?= $row['no_of_days'] ?>" placeholder="Stock Quantity"></td>
                                                                <td id="areaID_<?= $i ?>" >
                                                                    <?php if ($i + 1 == count($area_details)) { ?>
                                                                        <a onclick="addMore(<?= $i ?>)" id="addmoreArea"  class="addmoreArea btn btn-social-icon btn-primary"><i class="fa fa-plus"></i></a>
                                                                    <?php } ?>
                                                        ...
                                                        for ($i = 0; $i < count($product_images); $i++) {
                                                            ...
                                                            <div id="del_promo_img<?php echo $product_images[$i]['prod_img_pk_id']; ?>" style="display: block;">
                                                                <div id="abcd<?php echo $i; ?>" class="abcd col-md-6 promotional_img">
                                                                    <img style="margin-top:10px;margin-bottom:10px;" id="previewimg<?php echo $i; ?>" src="<?php echo base_url(); ?>assets/images/product_image/<?php echo $product_images[$i]['file_name']; ?>" width="137px" height="112px">
