                    ...
                    <div class="module-body">
                        <ul class="toggle-footer" style="">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <p>abc@gmail.com</p>
                                     <p> <a href="<?php echo base_url(); ?>page/contact" style="line-height: 0;margin-left: 0;">Contact Us</a></p>
                                </div>
                            </li>
                        </ul>
                    </div><!-- /.module-body -->
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div class="module-body">
                        <ul class="list-unstyled">
                            ...
                            <li><a href="<?php echo base_url(); ?>page/faq" title="faq">FAQ</a></li>
                            <li class="last"><a href="<?php echo base_url(); ?>page/help" title="Help Center">Help Center</a></li>
                    ...
                    <div class="module-body">
                        <ul class="list-unstyled">
                           <!-- <li class="first"><a href="myorder.php" title="Track Order">Track Order</a></li>-->
                            ...
                            <li><a href="<?php echo base_url(); ?>page/aboutus" title="About Company">About </a></li>
