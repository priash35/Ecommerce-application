                        ...
                        <div class="container">
                            ...
                            <div class="col-md-9 col-sm-9 text-right">
                                <form action="#" method="post">
                                    <div class="col-md-12">
                                    <div class="col-md-6"><input type="text" name="your name" placeholder="Your name" required=" "></div>
                                    <div class="col-md-6"><input type="text" name="your email" placeholder="Your email" required=" "></div>
                                    <div class="col-md-6"><input type="text" name="your subject" placeholder="Your subject" required=" "></div>
                                    <div class="col-md-6"><input type="text" name="your phone number" placeholder="Phone number" required=" "></div>
                                    <div class="col-md-12"><textarea name="your message" placeholder="Your message" required=" "></textarea></div>
                                    <div class="col-md-12">
