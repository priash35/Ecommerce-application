                        ...
                        <div class="product_slider ">
                            ...
                            <div id="owl-demo" class="owl-carousel">
								...
								foreach($NewArrivalsOffer as $result) {
									...
									//print_r($imgData[0]->file_name);
								?>
                                <div class="item"> 
                                    <i class="fav fa fa-heart-o" style="font-size:20px; margin-right:17px; color: black;" onclick="setColor(event, 'button', '#0023b2', '<?php echo $result['product_pk_id']?>' )"></i>
                                    ...
                                    <div class="col-item">
                                        <div class="photo">
											...
											<img src="<?php echo base_url();?>assets/images/product_image/<?=$imgData[0]->file_name?>" class="img-responsive" alt="a" />
											</a>
                                        </div>
										<?php //echo $imgData[0]->file_name; die();?>
...
<?php if(isset($thirdsection[0])&& $thirdsection[0]!=''){ ?>
