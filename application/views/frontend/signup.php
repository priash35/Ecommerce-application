                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-5 new-account">
                            ...
                            <div class="social-sign-in outer-top-xs">
                                <a href="javascript:void(0);" onclick="fblogin()" class="facebook-sign-in" style="margin-bottom: 10px; padding: 11px 30px;"><i class="fa fa-facebook"></i> Sign Up with Facebook</a>
...
//                        alert(JSON.stringify(response));
                        ...
                        $.ajax({
                            ...
                            {
                                document.location = "http://www.ecom.inncrotech.site";
                            }
                        });
//                                                        code
